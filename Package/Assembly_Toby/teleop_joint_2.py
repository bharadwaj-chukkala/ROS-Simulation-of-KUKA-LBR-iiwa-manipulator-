...
if __name__=="__main__":
    ...
    pub_right = rospy.Publisher('Assembly_Toby/joint_2_controller/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_left = rospy.Publisher('Assembly_Toby/joint_2_controller/command', Float64, queue_size=10)
